...
1. Write a C program to demonstrate the use of chmod system call to set filepermissions.
2. Write a C program to demonstrate the use of chown system call to change theowner of a file.
...
5. Write a C program to demonstrate inter-process communication (IPC) usingpipes.
